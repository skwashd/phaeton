"""
Models for the translation engine (Component 3) input.

These models represent the annotated workflow graph and analysis result
expected by the n8n-to-Step-Functions translation engine. They are the
canonical definitions consumed by the translator and upstream adapters.
"""
...
class WorkflowAnalysis(BaseModel):
    """
    Top-level analysis result consumed by the translation engine.
